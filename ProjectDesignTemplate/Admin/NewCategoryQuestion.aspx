<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewCategoryQuestion.aspx.cs" Inherits="ProjectDesignTemplate.Admin.NewCategoryQuestion" %>
        ...
        <div class="row no-gutters">
            <div class="col-6 col-md-2 bg-primary vh-100 d-flex align-items-center justify-content-center sticky-top flex-column" >
                ...
                <div class="links">
                    ...
                    <a href="SelectCategory.aspx" class="menuLinks  text-white text-decoration-none " >Edit Quiz</a>
                            ...
                            <div class="card-body">
                                 <div class="headerSection d-flex justify-content-between align-items-center">
                                     <div class="logo d-inline-flex align-items-center">
                                         ...
                                         <h4 class=" mb-0 ms-2">Add Items </h4>
                                     </div>
                                 <div>
                                         ...
                                         <div class="row">
                                             <div class="col-12 col-lg-6">
                                                ...
                                                <div class="mt-2">
                                                    ...
                                                    <div>
                                                        <asp:TextBox ID="que_txt" runat="server" TextMode="MultiLine" CssClass="form-control" Height="200px"></asp:TextBox>
                                                    </div>
                                                   </div>
                                             ...
                                             <div class="col-12 col-lg-6">
                                                 <div>
                                                     ...
                                                     <div class="row">
                                                         <div class="col-6"> 
                                                             <asp:TextBox ID="A1txt" runat="server" CssClass="form-control"></asp:TextBox>
                                                         </div>
                                                          <div class="col-6">
                                                              <asp:TextBox ID="A2txt" runat="server" CssClass="form-control"></asp:TextBox>
                                                         </div>
                                                     </div>
                                                     <div class="row">
                                                         <div class="col-6 mt-2">
                                                             <asp:TextBox ID="A3txt" runat="server" CssClass="form-control"></asp:TextBox>
                                                         </div>
                                                          <div class="col-6 mt-2">
                                                             <asp:TextBox ID="A4txt" runat="server" CssClass="form-control"></asp:TextBox>
                                                         </div>
                                                     </div>
                                                 </div>
                                                 <div class="correctAns mt-2">
                                                     ...
                                                     <div class="row">
                                                         <div class="col-12"> 
                                                             <asp:TextBox ID="correct_txt" runat="server" CssClass="form-control"></asp:TextBox>
                                                         </div>
                                                    </div>
                                                </div>
                                                 <div class="mt-2">
                                                  ...
                                                  <div class="mt-2">
                                                     <label for="" class=" form-label text-secondary d-block">Level</label>
                                                       <asp:DropDownList ID="lvlDropDown" CssClass="form-control form-select" runat="server" OnSelectedIndexChanged="lvlDropDown_SelectedIndexChanged" >
