<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newcategoryques.aspx.cs" Inherits="ProjectDesignTemplate.Admin.newcategoryques" %>
<!DOCTYPE html>
                                         ...
                                         <div class="row">
                                             <div class="col-12 col-lg-6">
                                                ...
                                                <div class="mt-2">
                                                    ...
                                                    <div>
                                                        <asp:TextBox ID="que_txt" runat="server" TextMode="MultiLine" CssClass="form-control" Height="200px" Required></asp:TextBox>
                                                    </div>
                                                   </div>
                                             ...
                                             <div class="col-12 col-lg-6">
                                                 ...
                                                 <div class="correctAns mt-2">
                                                     <label for="" class=" form-label text-secondary d-block">Correct Answer</label>
                                                     <div class="row">
                                                         <div class="col-12"> 
                                                  ...
                                                  <div class="mt-2">
                                                     <label for="" class=" form-label text-secondary d-block">Level</label>
                                                       <asp:DropDownList ID="lvlDropDown" CssClass="form-control form-select" runat="server" Required>
